...
RowLayout {
    ...
    property alias layoutLabel: layoutLabel
    property alias layoutRowLayout: layoutRowLayout
    property alias paperLabel: paperLabel
    property alias paperSizeComboBox: paperSizeComboBox
    property alias twoSidedLabel: twoSidedLabel
    property alias twoSidedRowLayout: twoSidedRowLayout
    property alias colorLabel: colorLabel
    property alias colorRowLayout: colorRowLayout
